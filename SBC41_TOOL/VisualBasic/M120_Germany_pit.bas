Attribute VB_Name = "M120_Germany_pit"
Sub mailGERMANYPIT()
...
'Next
'message = message & vbCrLf
'message = message & "So far, we did not find any stock by AIB stocks. " & vbCrLf
'message = message & "Could you please investigate possible Stock or FAL Rob possibilities? " & vbCrLf
'message = message & vbCrLf
