Attribute VB_Name = "M440_GENERIC_BROKER"
Sub mailbroker_GENERIC()
...
WSADDRESS.Cells(80, 2) = WSTEMPLATES.Cells(i, 15)

emailselection = 80
Call GENERIC_BROKER_EMAIL

i = i + 1

Loop While (WSTEMPLATES.Cells(i, 15) <> "")
