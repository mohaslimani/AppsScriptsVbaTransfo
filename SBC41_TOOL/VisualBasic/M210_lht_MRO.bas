Attribute VB_Name = "M210_lht_MRO"
Sub mailLHT_MRO()
...
If PROGRAM = "A380" Then
   notice = MsgBox("WARNING!! LUFTHANSA TECHNIK doesn't stock A380 material" & vbCrLf & vbCrLf & "Do you want to generate the e-mail anyway?", vbYesNo)
End If
