Attribute VB_Name = "M512_GENERIC_AIRLINE"
Sub mailAIRLINE_GENERIC()
...
WSADDRESS.Cells(80, 2) = WSTEMPLATES.Cells(i, 17)

emailselection = 80
Call GENERIC_AIRLINE_EMAIL

i = i + 1

Loop While (WSTEMPLATES.Cells(i, 17) <> "")
