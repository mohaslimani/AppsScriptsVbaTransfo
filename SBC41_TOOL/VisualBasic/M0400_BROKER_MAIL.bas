Attribute VB_Name = "M0400_BROKER_MAIL"
Sub BROKER_EMAIL()
...
If PNnumber = 1 Then
Message = Message & "We currently have the Customer mentioned below with the need of the following spare-part or interchangeabilities:" & vbCrLf
Else
Message = Message & "We currently have the Customer mentioned below with the need of the following spare-parts or interchangeabilities:" & vbCrLf
End If
...
Message = Message & "In case of part availability, would you mind providing us with a copy of either Authorised Release Certificate (ARC) or EASA Form 1 or Certificate of Conformity (CoC) as a proof to confirm direct ownership?" & vbCrLf
